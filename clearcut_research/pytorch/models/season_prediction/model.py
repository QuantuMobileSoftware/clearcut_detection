...
from clearcut_research.pytorch.models.season_prediction.encoder_decoder import EncoderDecoder
from segmentation_models_pytorch.encoders import get_encoder


class FPN_double_output(EncoderDecoder):
    ...
    def __init__(
        ...
        self.name = 'season_prediction-{}'.format(encoder_name)
